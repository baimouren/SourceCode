...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '目录' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_decade`  (
  ...
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '年份' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_level`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键',
  `is_use` int(11) NOT NULL COMMENT '是否在使用',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '等级名称',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` date DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改人',
  `update_time` date DEFAULT NULL COMMENT '修改时间',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '影片级别' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_loc`  (
  ...
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '地区' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_raty`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键',
  `en_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '时间',
  `film_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '影片id',
  ...
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '评分' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_res`  (
  ...
  `link` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '链接',
  `link_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '链接类型',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资源名称',
  `update_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新时间',
  `film_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '影片名称',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` date DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改人',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_subclass`  (
  ...
  `is_use` int(11) NOT NULL COMMENT '是否使用',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '名称',
  `catalog_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '目录id',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` date DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改人',
  `update_time` date DEFAULT NULL COMMENT '修改时间',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '子分类' ROW_FORMAT = Compact;
...
CREATE TABLE `t_bus_type`  (
  ...
  `subclass_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '子分类id',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` date DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改人',
  `update_time` date DEFAULT NULL COMMENT '修改时间',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '类型' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_bus_type
-- ----------------------------
INSERT INTO `t_bus_type` VALUES ('0620c8f57f42a4cc89cab6ddc33016d8', 1, '爱情', 'a559754ef20fda71b8dbf8ea1f6c8e94', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857a4c8c50157a8fe5ad8001b', 1, '犯罪', 'f39c979857a4c8c50157a8fe00ff001a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857a4c8c50157ac793ffc0029', 1, '惊悚', 'f39c979857a4c8c50157ac76b5140027', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857ad7e8c0157ae5d8ce30008', 1, '情色', 'f39c979857a4c8c50157a8fe00ff001a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857ad7e8c0157ae6ea77a000c', 1, '爱情', 'f39c979857a4c8c50157a8fe00ff001a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857ad7e8c0157af44759b0016', 1, '科幻', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857ad7e8c0157af4c961b001a', 1, '惊悚', 'f39c979857ad7e8c0157af45971a0018', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157b788a8c10003', 1, '爱情', 'f39c979857ad7e8c0157ae8927290011', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157b7a248fb0018', 1, '悬疑', 'f39c979857ad7e8c0157af45971a0018', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157b7b0c3120025', 1, '爱情', 'f39c979857b48a2a0157b7b0974e0024', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157b81d64dd003b', 1, '喜剧', 'f39c979857a4874a0157a4a723560001', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157b83b41680045', 1, '恐怖', 'f39c979857b48a2a0157b83af6940044', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157bdc2b98c004e', 1, '灾难', 'f39c979857b48a2a0157b83af6940044', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157bdd9e3b10055', 1, '科幻', 'f39c979857b48a2a0157bdd983220054', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157be5f4bd0007b', 1, '武侠', 'f39c979857b48a2a0157be5f224f007a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157bebe075200a1', 1, '家庭', 'f39c979857a4c8c50157a8fe00ff001a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157c2c3c94e00b2', 1, '武侠', 'f39c979857b48a2a0157c2c386d600b1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157c2c3f42800b3', 1, '奇幻', 'f39c979857b48a2a0157c2c386d600b1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157c2f13a6d00f1', 1, '犯罪', 'f39c979857b48a2a0157b7b0974e0024', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857b48a2a0157c30a04e7010b', 1, '奇幻', 'f39c979857b48a2a0157c3053fdc010a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c74ee3f80030', 1, '内详', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c75d1583003f', 1, '动作', 'f39c979857a4c8c50157a8fe00ff001a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c75d80c80040', 1, '动作', 'f39c979857b48a2a0157be5f224f007a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c77eac7d0054', 1, '喜剧', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c784d4f70056', 1, '奇幻', 'f39c979857ad7e8c0157ae8927290011', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c814e869005a', 1, '格斗', 'f39c979857b48a2a0157b83af6940044', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c81a48f4006a', 1, '格斗', 'f39c979857ad7e8c0157af45971a0018', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c822a1cf006b', 1, '格斗', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c8269392006c', 1, '惊悚', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c82d5f250080', 1, '动作', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c8319d420081', 1, '科幻', 'f39c979857c72e810157c74e89a8002e', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f39c979857c72e810157c83fd8d10098', 1, '冒险', 'f39c979857b48a2a0157be5f224f007a', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_type` VALUES ('f50bf782258bf4479e6573ced2c3bad5', 1, '感情', 'a559754ef20fda71b8dbf8ea1f6c8e94', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_bus_user`  (
  ...
  `is_vip` int(10) DEFAULT NULL COMMENT '是否vip',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `expire_time` datetime DEFAULT NULL COMMENT '过期时间',
  `user_email` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '用户邮箱',
  `user_name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '用户名称',
  `user_passwd` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '用户密码',
  `is_use` int(11) DEFAULT NULL COMMENT '是否使用',
  `create_by` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '修改人',
  `update_time` date DEFAULT NULL COMMENT '修改时间',
  `remark` text CHARACTER SET latin1 COLLATE latin1_swedish_ci COMMENT '备注'
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '用户' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_bus_user
-- ----------------------------
INSERT INTO `t_bus_user` VALUES ('a07e801e02284353aa9046923f39f07f', NULL, '2019-04-14 22:32:23', '2019-04-14 22:32:23', 'zuidaima@qq.com', 'zuidaima', '914E9FD07952B0B784D0618D40BA2AC8', NULL, NULL, NULL, '2019-04-14', NULL);
...
CREATE TABLE `t_bus_vip_code`  (
  ...
  `code` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '编码',
  `is_use` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '是否使用',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `expire_time` datetime DEFAULT NULL COMMENT '过期时间',
  `create_by` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '创建人',
  `update_by` varchar(64) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL COMMENT '修改人',
  ...
  `remark` text CHARACTER SET latin1 COLLATE latin1_swedish_ci COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = 'vip编码' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_bus_vip_code
-- ----------------------------
INSERT INTO `t_bus_vip_code` VALUES ('4666C87B01E641DAA3C9A87F1DF69711', 'D68A512F2AF24D1DB5DE3FCEF5A6EB77', '1', '2019-04-14 22:37:37', '2019-04-14 22:37:37', NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_vip_code` VALUES ('9EB9F4D7C26342E298456DA7929B8E25', 'B06A2307304242B6825426B1F89ADF30', '1', '2019-04-14 22:37:37', '2019-04-14 22:37:37', NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_vip_code` VALUES ('EEB295F78100490FBE5DE879F919D4A6', 'DA109EC1DCB040AF9F0EE58E7E685008', '1', '2019-04-14 22:37:37', '2019-04-14 22:37:37', NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_vip_code` VALUES ('EF552E6D918D4CABB665A4A6C6BADFB3', '39FC207185E24C3B8C39CFC9B7080779', '1', '2019-04-14 22:37:37', '2019-04-14 22:37:37', NULL, NULL, NULL, NULL);
INSERT INTO `t_bus_vip_code` VALUES ('F612FA6FF657498D8C21A2FD03C0C3B8', 'E8CFBD26F6D14FF3B67AABBB8346F330', '1', '2019-04-14 22:37:37', '2019-04-14 22:37:37', NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_sys_permission`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权限名称',
  `url` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权限路径',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权限描述',
  `pid` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '父权限id',
  `type` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权限类型：1:菜单 2:接口',
  `method` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `t_sys_role`  (
  ...
  `alias` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色别名',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色名',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `t_sys_role_permission_relation`  (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '主键id',
  `role_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色id',
  `permission_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '权限id',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '修改人',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `t_sys_user`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户名称',
  `org_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '所属组织id',
  `account` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '账户',
  `password` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '密码',
  `status` int(1) DEFAULT NULL COMMENT '状态, 0：离线 1：在线',
  `enable` int(1) DEFAULT NULL COMMENT '是否启用，0：禁用 1：启用',
  `last_login_time` datetime DEFAULT NULL COMMENT '最后登录时间',
  `last_login_ip_address` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '最后登录ip地址',
...
CREATE TABLE `t_sys_user_role_relation`  (
  `id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '主键id',
  `user_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '用户角色',
  `role_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色id',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '修改人',
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '用户角色关联表' ROW_FORMAT = Compact;
